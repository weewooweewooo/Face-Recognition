                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description"> Add Enrollment / Subject for Students </p>
                                    <form class="forms-sample" method="POST">
                                        {% csrf_token %}
                                        <div class="form-group">
                                            <label for="courseName">Course Name</label>
                                            <select class="form-control" id="subject_id" name="subject_id" style="color:white;">
                                                <option value="" selected disabled>Select a course</option>
                                                {% for subject in subjects %}
                                                <option value="{{ subject.id }}" data-code="{{ subject.code }}" data-faculty="{{ subject.faculty }}">{{ subject.name }}</option>
                                                {% endfor %}
                                            </select>
                                        </div>
                                        ...
                                        <a class="btn btn-dark" href="{% url 'enrollment' %}">Cancel</a>
                                    </form>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    document.getElementById('subject_id').addEventListener('change', function() {
        ...
        // Retrieve the data attributes for Course Code and Faculty
